...
// Translations
$langs->loadLangs(array("admin", "navsend@navsend"));
...
dol_fiche_head($head, 'settings', '', -1, "navsend@navsend");

// Setup page goes here
echo '<span class="opacitymedium">'.$langs->trans("NavSendSetupPage").'</span><br><br>';
